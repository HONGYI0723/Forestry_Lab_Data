...
# plot, code, the number of rows for each group.
...
#----------------
dom_cnt <- dom_cnt %>% mutate(rel_abd = (n/Ttl_Trees)*100)
#----------------

# Question 7: How many trees are there at plot A5? 24
# Question 8: How many different tree species are there at plot D1? 10
