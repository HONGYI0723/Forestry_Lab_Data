...
sum_u2 <- sum_u2 %>% rename(Abundance= n)
#----------------
...
#----------------
sum_u2$biomass_tons_per_acre <- sum_u2$biomass_per_acre / 1000
#----------------
...
sum_u2 <- sum_u2 %>% mutate(Common.name= ifelse(rel_abd < 50, "Mixed",Common.name))

# Remove duplicate rows
sum_u2 <- sum_u2 %>% distinct() 
sum_u2$richness.y <-NULL
#----------------
...
#----------------
getwd()
write.csv(sum_u2,"Final2.csv",row.names = FALSE )
#----------------
library(ggplot2)
