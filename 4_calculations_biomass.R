...
Bm_equa <-read.csv("https://raw.githubusercontent.com/HONGYI0723/Forestry_Lab_Data/refs/heads/main/Biomass%20Equation.csv")
...
#----------------
sum_u2_bm <- sum_u2_bm %>% mutate(biomass_per_acre= biomass* unique(trees$EF))
...
#----------------
sum_u2 %>% arrange(desc(biomass_per_acre))
getwd()
write.csv(sum_u2,"CHECK42.csv",row.names = FALSE )
#---------
